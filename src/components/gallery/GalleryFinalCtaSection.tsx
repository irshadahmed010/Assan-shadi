...
export const GalleryFinalCtaSection: React.FC = () => {
  return (
    <section
      id="gallery-cta"
          ...
          <div className="relative z-10 max-w-3xl space-y-6">
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="space-y-4 text-stone-300 text-sm sm:text-base font-sans-modern leading-relaxed">
                <p>
                  Every unforgettable photograph in our gallery started with a sincere intention and a single step. Asaan Shaadi connects you with verified individuals and families who respect your values.
                </p>
                <p>
                  Discover compatible partners with dignified privacy, phone verification, and zero compromise on personal ideals.
                </p>
              </div>
            </ScrollReveal>
