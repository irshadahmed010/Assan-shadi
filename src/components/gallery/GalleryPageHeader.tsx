...
import { Home, ChevronRight, Sparkles, Heart } from "lucide-react";

export const GalleryPageHeader: React.FC = () => {
  return (
    <section
      id="gallery-page-header"
      ...
      aria-label="Gallery Page Header Banner"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 min-w-0">
          ...
          >
            ...
            <span className="text-[#e8a379] font-medium truncate">Gallery</span>
          </nav>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-[#9a6a4f]/20 border border-[#9a6a4f]/40 text-[#FAF7F2] text-[11px] sm:text-xs font-sans-modern">
            <Heart className="w-3.5 h-3.5 text-[#e8a379] fill-[#e8a379]/40 shrink-0" />
            <span className="font-medium hidden xs:inline">Blessed Unions</span>
            <span className="font-medium xs:hidden">Unions</span>
            <span className="hidden sm:inline text-stone-400">•</span>
            <span className="hidden sm:inline text-stone-300">Real Couples</span>
          </div>

          <div className="hidden lg:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#b9965b]/15 border border-[#b9965b]/30 text-[#e8c078] text-[11px] font-sans-modern">
