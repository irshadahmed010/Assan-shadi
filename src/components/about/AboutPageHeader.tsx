...
export const AboutPageHeader: React.FC = () => {
  return (
    <section
      ...
      className="relative h-[130px] min-h-[130px] max-h-[120px] w-full bg-[#1e1e1e] border-b border-[#9a6a4f]/30 flex items-center overflow-hidden z-20"
      aria-label="About Page Header Banner"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 min-w-0">
          ...
          >
            ...
            <span className="text-[#e8a379] font-medium truncate">About Us</span>
          </nav>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-[#9a6a4f]/20 border border-[#9a6a4f]/40 text-[#FAF7F2] text-[11px] sm:text-xs font-sans-modern">
            ...
            <span className="font-medium hidden xs:inline">100% Phone Verified</span>
